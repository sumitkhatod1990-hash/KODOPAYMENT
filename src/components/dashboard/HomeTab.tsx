      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <div className="p-6 rounded-3xl bg-white border border-black/10 shadow-sm space-y-2">
          <div className="flex justify-between items-center text-xs text-[#86868b] font-medium">
            <span>Gross Payment Volume</span>
          ...
          <div className="flex items-center gap-1.5 text-xs text-[#86868b] font-semibold">
            ...
            <span>{transactions.length} recorded payment{transactions.length === 1 ? '' : 's'}</span>
          </div>
        </div>
        ...
        <div className="p-6 rounded-3xl bg-white border border-black/10 shadow-sm space-y-2">
          ...
          <div className="text-xs text-[#86868b] font-semibold">
            Conversion: <strong>{transactions.length > 0 ? analytics?.conversionRate : '—'}</strong>
          </div>
        </div>
      ...
      <div className="p-7 rounded-3xl bg-white border border-black/10 shadow-sm space-y-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-[#86868b]">
              Recorded payment activity in the current QivroPay workspace
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          ...
          <p className="text-xs text-[#6e6e73]">
            Create one-time products and shareable INR checkout links.
          </p>
        </div>
        ...
        >
          ...
          <p className="text-xs text-[#6e6e73]">
            Generate a hosted checkout URL for WhatsApp, email, or invoices.
          </p>
        </div>
        ...
        >
          ...
          <p className="text-xs text-[#6e6e73]">
            Track Cashfree Partner onboarding, KYC, and payment access status.
          </p>
        </div>
      ...
      <div className="p-7 rounded-3xl bg-white border border-black/10 shadow-sm space-y-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-[#86868b]">
              Payments recorded for this merchant workspace
            </p>
          </div>
