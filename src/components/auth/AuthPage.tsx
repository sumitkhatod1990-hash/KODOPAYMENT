...
export const AuthPage: React.FC = () => {
  ...
  const useDemoAccount = () => { setMode('login'); setEmail('demo@qivropay.com'); setPassword('QivroDemo2026!'); setError(''); };
