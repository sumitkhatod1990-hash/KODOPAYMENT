...
export const ComparisonTable: React.FC = () => {
  const comparisonRows = [
    { feature: "Built-in Payment Infrastructure ", qivropay: true, stripe: false, ls: true, paddle: true },
    { feature: "Credit-Pack Products for AI/SaaS Billing", qivropay: true, stripe: false, ls: false, paddle: false },
    { feature: "Instant UPI & Card Checkout (India)", qivropay: true, stripe: true, ls: true, paddle: true },
  ];
